...
MCCamera::MCCamera(float y_FOV, float rot_speed, float mov_speed) : y_FOV(y_FOV), rotation_speed(rot_speed), mov_speed(mov_speed)
{
...
void MCCamera::setViewMatrix(glm::vec4 eye, glm::vec4 side, glm::vec4 up, glm::vec4 look_at)
{
    this->eye = eye;
...
void MCCamera::setUBO(std::vector<float>& cam_data)
{
...
void MCCamera::setOrientation(float zoom, float zenith, float azimuth)
{

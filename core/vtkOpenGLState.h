...
public:
  ...
  class  ScopedglScissor : public ScopedValue<std::array<int, 4>>
  {
  public:
  ...
  class ScopedglDepthFunc : public ScopedValue<unsigned int>
  {
  public:
    ScopedglDepthFunc(vtkOpenGLState* state);
  };
  class ScopedglActiveTexture : public ScopedValue<unsigned int>
  {
  public:

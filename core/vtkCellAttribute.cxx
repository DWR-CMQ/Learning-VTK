...
struct SpaceExp0 : TAO_PEGTL_ISTRING("0")
{
};
// NB: These strings may appear the same, but one is unicode code-point 0xb1
//     while the other is 0x2071:
struct SpaceExp1 : sor<TAO_PEGTL_ISTRING("1"), TAO_PEGTL_ISTRING("i")>
{
};
struct SpaceExp2 : TAO_PEGTL_ISTRING("2")
{
};
struct SpaceExp3 : TAO_PEGTL_ISTRING("3")
{
};
struct SpaceExp4 : TAO_PEGTL_ISTRING("4")
{
};
struct SpaceExp5 : TAO_PEGTL_ISTRING("5")
{
};
struct SpaceExp6 : TAO_PEGTL_ISTRING("6")
{
};
struct SpaceExp7 : TAO_PEGTL_ISTRING("7")
{
};
struct SpaceExp8 : TAO_PEGTL_ISTRING("8")
{
};
struct SpaceExp9 : TAO_PEGTL_ISTRING("9")
{
};
...
struct SpaceAction<SpaceExp>
{
  ...
  static void apply(const Input& in, std::string& base, double& exp, int& halfspace)
  {
    ...
    //static std::string oneA("1");     // ¹
    //static std::string oneB("1"); // ⁱ

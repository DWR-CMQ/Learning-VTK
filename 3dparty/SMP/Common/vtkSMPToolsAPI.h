...
#include "../../CommonCore/src/vtkNew.h"
#include "../../CommonCore/src/vtkObject.h"
#include "../../CommonCore/src/vtkSMP.h"
...
class COMMONCORE_EXPORTS vtkSMPToolsAPI
{
public:
  //--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
class COMMONCORE_EXPORTS vtkSMPToolsAPIInitialize
{
public:

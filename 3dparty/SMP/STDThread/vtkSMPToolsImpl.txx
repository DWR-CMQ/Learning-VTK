...
#include "../../CommonCore/src/vtkCommonCoreModule.h"
...
int COMMONCORE_EXPORTS GetNumberOfThreadsSTDThread();
...
//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS void vtkSMPToolsImpl<BackendType::STDThread>::Initialize(int);

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS int vtkSMPToolsImpl<BackendType::STDThread>::GetEstimatedNumberOfThreads();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS int vtkSMPToolsImpl<BackendType::STDThread>::GetEstimatedDefaultNumberOfThreads();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS bool vtkSMPToolsImpl<BackendType::STDThread>::GetSingleThread();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS bool vtkSMPToolsImpl<BackendType::STDThread>::IsParallelScope();

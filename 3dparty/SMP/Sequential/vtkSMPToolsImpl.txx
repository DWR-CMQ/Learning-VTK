...
//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS void vtkSMPToolsImpl<BackendType::Sequential>::Initialize(int);

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS int vtkSMPToolsImpl<BackendType::Sequential>::GetEstimatedNumberOfThreads();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS bool vtkSMPToolsImpl<BackendType::Sequential>::GetSingleThread();

...
class vtkSMPToolsImplOpenMPInitialize
{
public:
...
//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS void vtkSMPToolsImpl<BackendType::OpenMP>::Initialize(int);

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS int vtkSMPToolsImpl<BackendType::OpenMP>::GetEstimatedNumberOfThreads();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS int vtkSMPToolsImpl<BackendType::OpenMP>::GetEstimatedDefaultNumberOfThreads();

//--------------------------------------------------------------------------------
template <>
COMMONCORE_EXPORTS bool vtkSMPToolsImpl<BackendType::OpenMP>::GetSingleThread();

...
class vtkIndent;
COMMONCORE_EXPORTS ostream& operator<<(ostream& os, const vtkIndent& o);

class COMMONCORE_EXPORTS vtkIndent
{
public:
   ...
   */
  friend COMMONCORE_EXPORTS ostream& operator<<(ostream& os, const vtkIndent& o);

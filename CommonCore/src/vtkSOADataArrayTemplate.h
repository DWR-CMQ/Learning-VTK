...
class COMMONCORE_EXPORTS vtkSOADataArrayTemplate
...
#define VTK_SOA_DATA_ARRAY_TEMPLATE_INSTANTIATE(T)                                                 \
  ...
  VTK_ABI_NAMESPACE_BEGIN                                                                          \
  template class vtkSOADataArrayTemplate<T>;                                  \
  VTK_ABI_NAMESPACE_END
...
#endif
VTK_ABI_NAMESPACE_BEGIN
vtkExternTemplateMacro(extern template class COMMONCORE_EXPORTS vtkSOADataArrayTemplate);
#ifdef _MSC_VER
#pragma warning(pop)
#endif
VTK_ABI_NAMESPACE_END
...
VTK_ABI_NAMESPACE_BEGIN
vtkInstantiateTemplateMacro(extern template class COMMONCORE_EXPORTS vtkSOADataArrayTemplate);

...
template <class T>
class COMMONCORE_EXPORTS vtkArrayIteratorTemplate : public vtkArrayIterator
{
public:
...
#endif
vtkInstantiateTemplateMacro(extern template class vtkArrayIteratorTemplate);
extern template class vtkArrayIteratorTemplate<vtkStdString>;
extern template class vtkArrayIteratorTemplate<vtkVariant>;
#ifdef _MSC_VER
#pragma warning(pop)
#endif
#endif

...
void COMMONCORE_EXPORTS vtkGarbageCollectorReportInternal(
...
class COMMONCORE_EXPORTS vtkGarbageCollector : public vtkObject
{
public:
...
private:
  ...
  friend void COMMONCORE_EXPORTS vtkGarbageCollectorReportInternal(
    vtkGarbageCollector*, vtkObjectBase*, void*, const char*);
 ...
 */
void COMMONCORE_EXPORTS vtkGarbageCollectorReport(

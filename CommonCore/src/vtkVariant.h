...
COMMONCORE_EXPORTS ostream& operator<<(ostream& os, const vtkVariant& val);

class COMMONCORE_EXPORTS vtkVariant
{
public:
  /**
  ...
  friend COMMONCORE_EXPORTS ostream& operator<<(ostream& os, const vtkVariant& val);
...
VTK_ABI_NAMESPACE_BEGIN
struct COMMONCORE_EXPORTS vtkVariantLessThan
{
public:
  bool operator()(const vtkVariant& s1, const vtkVariant& s2) const;
};

struct COMMONCORE_EXPORTS vtkVariantEqual
{
public:
  bool operator()(const vtkVariant& s1, const vtkVariant& s2) const;
};

struct COMMONCORE_EXPORTS vtkVariantStrictWeakOrder
{
public:
  bool operator()(const vtkVariant& s1, const vtkVariant& s2) const;
};
...
struct COMMONCORE_EXPORTS vtkVariantStrictEquality
{
public:
  bool operator()(const vtkVariant& s1, const vtkVariant& s2) const;
};
